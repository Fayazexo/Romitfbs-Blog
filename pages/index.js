import {
  AspectRatioBox, Avatar, Box, Button, Divider, Flex, Heading, Link, List, ListIcon, ListItem, Stack, Text
} from '@chakra-ui/core';
    ...
    <Flex justifyContent="center" flexDirection="column">
      ...
      >
        ...
        >
          ...
          With 5 years of experience in creating and managing online marketing strategy for brands big and small. I’m a specialist in brand development, website design, online community management, education, and ongoing web marketing strategy and project management.
          </Text>
          <Text color="gray.700" mb={4}>
          My philosophy is to use creativity to solve problems; to find new ways to make things happen. To me this means approaching every challenge as an opportunity for innovation – not just doing what works but always looking for better solutions that work better. And it means focusing on excellence in everything we do: our products are designed with care from conception through implementation; our service is delivered by people who take pride in their work.
          </Text>
          <Text color="gray.700" mb={4}>
          <b>School</b> taught me relationships mean more than degrees and titles
          </Text>
          <Text color="gray.700" mb={4}>
          <b>College</b> taught me self motivation, teamwork, resolving conflicts
          </Text>
          <Text color="gray.700" mb={4}>
          <b>University</b> taught me critical thinking, independence, and communication skill
          </Text>
          <Heading
            letterSpacing="tight"
            mb={4}
          ...
          <Text color="gray.700" mb={4}>
          I have an innovative spirit that meshes well with the ever-changing world of technology; this is reflected in my work as well as in the business strategies that I develop for businesses looking to expand their reach through digital marketing.
          </Text>
          <Text color="gray.700" mb={4}>
          Over the years, I’ve helped a wide variety of clients with their online presence – from artists to small businesses to nonprofits. Whether you need a few hours of consultation or ongoing help with your website, my service options are flexible enough for any budget or schedule! Plus, I take pride in my work and enjoy watching my clients get excited about marketing because it’s so rewarding to see them grow.
          </Text>
          ...
          ভ্রমনের সময় দুঃখ কষ্ট রাগ ইগো ঘরে রেখে ঘুরতে যাওয়া উচিত , আপনার অনুভুতি অন্যের উপর প্রভাব ফেলে । &nbsp;
            <Link
              isExternal
              fontWeight="bold"
          ...
          I have been following CaseyNeistat, Logan Paul, Irfan junejo, and Hamza Ibrahim for a long time. I always wished to document my life through vlogs/videos. But before the camera is not comfortable for me too much because it makes me feel uneasy in front of everyone watching videos on YouTube but now trying to face my fear by posting more often than anything else
          </Text>
          <Text color="gray.700" mt={4} mb={8}>
          I’m going to get over that fear right quick with your help! So if you wanna see me fail miserably or be successful on video just hit subscribe&nbsp;
            <Link
              isExternal
              fontWeight="bold"
          ...
          <Stack mt={8} spacing={8}>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/ko_qrEzK-QQ/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/QwcqBCinSzU/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/_Mw9bluYBi4/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/LXBIO88rgX4/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/IrqrsfL6Y2s/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/YwU80F06mQ4/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/4EWVBce2Zj8/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/sPkdNvw9M6M/maxresdefault.jpg"}
            >
            </VideoCard>
            <VideoCard
              ...
              image={"http://img.youtube.com/vi/w1WOqtg-4_E/maxresdefault.jpg"}
            >
            </VideoCard>
          </Stack>
          ...
          <Flex align="center">
            ...
            <Box>
              <Text color="gray.700" mt={4} fontSize={['sm', 'lg']}>
                <b>I'm Fahad Bin Saad</b> –– DevRel, Writer, YouTuber, and a marketing nerd.
              </Text>
              <Link
                mt={2}
                isExternal
